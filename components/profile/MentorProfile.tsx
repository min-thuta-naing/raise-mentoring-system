...
import { User, Mail, Briefcase, Clock, Users, BookOpen, Camera, Save, X, Pencil, ImageIcon, CheckCircle } from 'lucide-react';
                ...
                <div className="bg-black/40 border border-white/20 rounded-[1.5rem] p-8 backdrop-blur-xl shadow-2xl flex flex-col md:flex-row items-center gap-8 -mt-24 mx-8 md:mx-auto max-w-4xl relative z-10 transition-all hover:bg-black/50">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        <div className="flex flex-col md:flex-row md:items-center gap-3 mb-2">
                             ...
                             <span className="bg-[#454040]/10 text-[#454040] border border-[#454040]/20 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider w-fit mx-auto md:mx-0">Mentor</span>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-[#0f172a] border border-white/10 p-6 rounded-[1.5rem] shadow-lg relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                            <Clock size={48} className="text-[#454040]" />
                        </div>
                        <p className="text-[#AAB2C8] text-xs font-bold uppercase tracking-widest mb-1">Total Teaching</p>
                        <div className="flex items-baseline gap-1">
                            <h3 className="text-3xl font-bold text-white">{totalHours}</h3>
                            <span className="text-sm text-[#AAB2C8] font-bold">hrs</span>
                        </div>
                        <p className="text-[10px] text-[#AAB2C8] mt-4 font-bold tracking-tight">Approved Session Volume</p>
                    </div>
                    ...
                    <div className="bg-[#0f172a] border border-white/10 p-6 rounded-[1.5rem] shadow-lg relative overflow-hidden group">
                        ...
                        <p className="text-[#AAB2C8] text-xs font-bold uppercase tracking-widest mb-1">Groups Managed</p>
                        <h3 className="text-3xl font-bold text-white">{myGroupsCount}</h3>
                        <p className="text-[10px] text-[#AAB2C8] mt-4 font-bold tracking-tight">Mentorship Reach</p>
                    </div>
                    ...
                    <div className="bg-[#0f172a] border border-white/10 p-6 rounded-[1.5rem] shadow-lg relative overflow-hidden group text-[#454040]/80">
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                            <BookOpen size={48} className="text-[#454040]" />
                        </div>
                        <p className="text-[#AAB2C8] text-xs font-bold uppercase tracking-widest mb-1">Sessions Conducted</p>
                        <h3 className="text-3xl font-bold text-white">{myLogs.length}</h3>
                        <p className="text-[10px] text-[#AAB2C8] mt-4 font-bold tracking-tight">Total Activity Log</p>
                    </div>
                </div>
            </div>
